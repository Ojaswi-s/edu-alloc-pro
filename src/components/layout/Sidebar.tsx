...
import { LayoutDashboard, UserPlus, ClipboardList, Sparkles, School2, Users } from 'lucide-react';
    ...
    <aside className="hidden lg:flex w-60 shrink-0 flex-col border-r border-sidebar-border bg-sidebar h-screen sticky top-0">
      ...
      <div className="p-4 border-t border-sidebar-border">
        <div className="rounded-md bg-surface-elevated p-3 border border-border">
          <div className="text-[10px] uppercase tracking-wider text-muted-foreground mb-1">Officer</div>
          <div className="text-sm font-semibold">Dr. M. Pawar</div>
          <div className="text-xs text-muted-foreground">District Collector · Nandurbar</div>
        </div>
      </div>
    </aside>
  );
